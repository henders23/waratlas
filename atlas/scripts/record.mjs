...
//
// Usage: [WAR=napoleonic] node scripts/record.mjs <base-url> <out-dir> <first-frame> <last-frame>
...
await page.goto(`${base}?capture&war=${process.env.WAR ?? 'mongol'}`, { waitUntil: 'load' });
